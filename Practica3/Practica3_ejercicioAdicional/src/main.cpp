...
// 🔹 Callbacks para la conexión/desconexión BLE
...
void loop() {
    ...
    // 📌 Salida bonita en la terminal
    Serial.println("\n════════════════════════════════════");
    Serial.println("📡  Datos del Sensor BLE");
    Serial.println("════════════════════════════════════");
    ...
    if (deviceConnected) {
        ...
        Serial.println("⚠️  No hay dispositivos conectados");
    }
